...
<title>Taj Hotels & Resorts | Booking</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <span class="link-text">Hotel</span>
        ...
        <a href="booking1.php" class="nav-link active">
...
<main class="main" id="main">
    ...
    <section class="form-hero">
        <img src="booking.png" class="form-hero-image" alt="">
        ...
        <div class="form-panel">
            ...
            <div class="form-page-header">
                ...
                <p>Reservation & Stay Records</p>
            </div>

<?php
/* ===== YOUR ORIGINAL — DB connection — UNCHANGED ===== */
...
?>
            ...
            <form action="booking.php" method="post" name="f" class="form-card">
                <div class="form-grid">

                    <div class="form-group">
                        <label>Booking ID</label>
                        <input type="text" name="t1" placeholder="Enter Booking ID">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="t2">
<?php
/* ===== YOUR ORIGINAL — Room ID dropdown query — UNCHANGED ===== */
$sql=mysqli_query($conn,"SELECT * FROM room ORDER BY room_id");
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="t3">
<?php
/* ===== YOUR ORIGINAL — Customer ID dropdown query — UNCHANGED ===== */
...
?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="t4" placeholder="dd-mm-yyyy">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="t6" placeholder="9876543210">
                    </div>

                    <div class="form-group">
                        <label>Reference</label>
                        <input type="text" name="t7" placeholder="Enter Reference">
                    </div>

                    <div class="form-group">
                        <label>Created Date</label>
                        <input type="text" name="t8" placeholder="dd-mm-yyyy">
                    </div>

                    <div class="form-group full-width">
                        <label>Created By</label>
                        <input type="text" name="t9" placeholder="Admin">
                    </div>
