...
class hotel extends connect
{
 	...
 	public function __construct()
	{
	 ...
	 private function renderHeader($title = "Hotel Results")
    {
        echo <<<HTML
<!DOCTYPE html>
<html lang="en">
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="hotel1.php" class="nav-link active"><span class="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18"/><path d="M8 3v4"/><path d="M16 3v4"/></svg></span><span class="link-text">Hotel</span></a>
	...
	public function input()
{
    if($this->db_handle)
    {
        ...
        $r=mysqli_query($this->db_handle,
        "SELECT hotel_code FROM hotel");
	...
	public function All_Search()
{
    if($this->db_handle)
    {
        ...
        $this->renderHeader("All Hotel Records");
	...
	public function PSearch()
{
    if($this->db_handle)
    {
        ...
        $this->renderHeader("Hotel Search Result");
